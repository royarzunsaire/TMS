...
namespace SGC.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            switch (result)
            {
                case SignInStatus.Success:
                    ...
                    AspNetUsersHistorial historial = new AspNetUsersHistorial
                    {
                        usuario = db.AspNetUsers.Where(u => u.Id == user.Id).FirstOrDefault(),
                        FechaLogin = DateTime.Now
                    };
                    db.AspNetUsersHistorial.Add(historial);
                    db.SaveChanges();
        ...
        public void LoadMenu(string UserdID)
        {
            ...
            {
                InsecapContext db = new InsecapContext();
                IEnumerable<MenuTemp> loadMenu = db.Database.SqlQuery<MenuTemp>("SP_Load_Menu @UserID ='" + UserdID + "'").ToList();
            }
            catch (Exception)
            {
